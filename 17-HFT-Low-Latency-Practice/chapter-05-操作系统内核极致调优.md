...
→ [07-The-Linux-Programming-Interface 调度](../07-The-Linux-Programming-Interface/)
...
→ [chapter-06 §5](./chapter-06-低延迟网络与协议优化.md#5-数据包生命周期kernel-路径) · [chapter-10 §1](./chapter-10-延迟测量与基准压测.md#1-内核旁路-kernel-bypass) · [13-DPDK](../14-DPDK-Low-Latency-Network/)
