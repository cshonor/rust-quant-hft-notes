...
> **HFT 阶段 1：** 先读 **Ch2**（配合 [01-CSAPP Ch6](../01-CSAPP-3rd/chapter-06-memory-hierarchy/)），再读 [14-Systems-Performance](../15-Systems-Performance-2nd/)。Ch5 内存一致性可与 CSAPP Ch12 交叉。
