...
- 行情：**预分配 mbuf / ring buffer**，热路径零 malloc（→ [10-DPDK 01-Intro ch02](../../../12-DPDK-Low-Latency-Network/01-Intro-Book/notes/chapter-02-mbuf与内存池/)）。
...
→ [05-LKD](../../../05-Linux-Kernel-Development/) 调度与绑核 · [12-HFT ch05](../../../13-HFT-Low-Latency-Practice/chapter-05-操作系统内核极致调优/)
