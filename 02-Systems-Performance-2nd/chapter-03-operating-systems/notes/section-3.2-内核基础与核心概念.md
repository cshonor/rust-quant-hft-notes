...
**调优直觉：** 热路径 **少 syscall、少拷贝、少阻塞**；内核旁路见 [10-DPDK](../../../12-DPDK-Low-Latency-Network/)、用户态栈。
...
- **isolcpus / 专用核**： housekeeping 与 hot path 分离 → [10-HFT ch05](../../../13-HFT-Low-Latency-Practice/chapter-05-操作系统内核极致调优/)
