...
> **与 UNP 分工：** [PNP](https://github.com/cshonor/Computer-Networking/tree/main/PNP) = 工程向实验；[UNP Vol.1](../10-UNP-Vol1/) = Stevens 系统化 API。  
> **推荐顺序：** `07` TLPI → `08` 自制系统 → **本模块 `09`** → `10` UNP → `11`–`13` 网络
...
- **下一步 · API 系统化：** [10-UNP-Vol1](../10-UNP-Vol1/)
- 协议语义 → [11-TCP-IP-Illustrated-Vol1](../11-TCP-IP-Illustrated-Vol1/)
...
- 系统底层 → [08-system-low-level-hands-on](../08-system-low-level-hands-on/)
- 工程落地 → [14-HFT-Low-Latency-Practice](../14-HFT-Low-Latency-Practice/)
