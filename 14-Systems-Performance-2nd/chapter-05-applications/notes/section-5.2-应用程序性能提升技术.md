...
- 行情：**预分配 mbuf / ring buffer**，热路径零 malloc（→ [13-DPDK 01-Intro ch02](../../../13-DPDK-Low-Latency-Network/01-Intro-Book/notes/chapter-02-mbuf与内存池/)）。
...
- 多交易所 TCP 订单通道 → **epoll + 非阻塞**（→ [10-UNP](../../../10-UNP-Vol1/)）
...
→ [02-Hennessy Ch2](../../../02-Computer-Architecture-6th/) MESI · [13-DPDK CROSS-MODULE](../../CROSS-MODULE-GUIDE.md#四内存与-cache-对照)
...
→ [03-Linux-Kernel-Development](../../../03-Linux-Kernel-Development/) 调度与绑核 · [12-HFT ch05](../../../16-HFT-Low-Latency-Practice/chapter-05-操作系统内核极致调优/)
