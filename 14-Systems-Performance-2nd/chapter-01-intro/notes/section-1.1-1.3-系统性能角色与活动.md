...
- 与 [10-HFT ch10 延迟测量](../../../16-HFT-Low-Latency-Practice/chapter-10-延迟测量与基准压测/) 衔接
...
| **内核栈** | 协议栈延迟、锁、cross-NUMA | `perf`、`ftrace` · [13-DPDK bypass](../../../13-DPDK-Low-Latency-Network/) |
...
| **端到端** | P50/P99/P999、抖动 tail | 硬件 timestamp / [HFT ch10 延迟测量](../../../16-HFT-Low-Latency-Practice/chapter-10-延迟测量与基准压测/) |
