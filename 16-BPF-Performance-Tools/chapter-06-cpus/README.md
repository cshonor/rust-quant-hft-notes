...
- [ ] **`runqlat` 是绑核健康度体温计**— dedicated 策略核右尾应极短；与 [SysPerf Ch6](../../15-Systems-Performance-2nd/chapter-06-cpus/) 一致。
...
- SysPerf CPU：[chapter-06-cpus](../../15-Systems-Performance-2nd/chapter-06-cpus/)
- SysPerf BPF 总览：[chapter-15-bpf](../../15-Systems-Performance-2nd/chapter-15-bpf/)
- 体系结构/cache：[02-Hennessy](../03-Computer-Architecture-6th/) · [01-CSAPP Ch6](../01-CSAPP-3rd/chapter-06-memory-hierarchy/)
