...
> **HFT：** 发布二进制若 **省略帧指针**，火焰图会出现 `<unknown>` 或错误栈 — 与 [SysPerf Ch 6 CPU](../../../15-Systems-Performance-2nd/chapter-06-cpus/) 的 `-g` / FPO 讨论同构。策略 SO 建议 **保留 frame pointer** 或配 USDT/静态探针。
