...
**HFT 构建链：** 与 [SysPerf Ch 6 CPU](../../../15-Systems-Performance-2nd/chapter-06-cpus/) **FPO 讨论同构** — 性能与可观测性 trade-off，热路径可 **USDT 替代高频 uprobe**。
...
→ 本仓库：[18-Rust-Quant-Trading-Guide](../18-Rust-Quant-Trading-Guide/)
