...
| 与 01 川合 OS 对照？ | 01：**BIOS · 软盘 · 0x7C00**；Mikan：**UEFI · FAT · BOOTX64.EFI · 长模式** |
...
- 对照：[01 Day 1 引导](../../01-30days-os/day-01-boot-asm/) · [附录 F ASCII](../appendix-F-ascii-table/) · [SETUP](../SETUP.md)
