...
- **`ipl.asm`** — 软盘上 **512 B**，单独占 **第 1 扇区**（你已有 [ipl.asm](../code/ipl.asm)）  
- **`nasmhead` + `bootpack.c` + `asmfunc`** — 都在 **bootpack 那一包**里，被 IPL **一次性读进 `0x8200` 起** 的内存  
...
| **仓库** | [code/ipl.asm](../code/ipl.asm) ✅ 已有 |
...
| **对照** | [§3.4.3 极简版](../code/example/nasmhead-minimal.asm) |
