...
**技术板块已封顶（`00`–`15`）** — 文件夹名排序；**推荐阅读顺序**见下与 [LEARNING-CHAIN.md](./LEARNING-CHAIN.md)。
...
→ 04 Hennessy → 05 LKD → 06 Gorman → 07 TLPI
→ 08 自制 OS/CPU → 09 陈硕 PNP/muduo → 10 UNP
→ 11 TCP/IP → 12 Rosen → 13 DPDK
→ 14 HFT 工程 → 15 Rust 量化
```
...
| 08 | [08-system-low-level-hands-on](./08-system-low-level-hands-on/) | **系统底层动手** · 30 天 OS / CPU |
| 09 | [09-Practical-Network-Programming](./09-Practical-Network-Programming/) | **C++ 网络实战** · 陈硕 PNP / muduo |
| 10 | [10-UNP-Vol1](./10-UNP-Vol1/) | UNP · Socket API |
| 11 | [11-TCP-IP-Illustrated-Vol1](./11-TCP-IP-Illustrated-Vol1/) | TCP/IP 卷一 · 协议语义 |
| 12 | [12-Linux-Kernel-Networking](./12-Linux-Kernel-Networking/) | Rosen · 内核网络栈 |
| 13 | [13-DPDK-Low-Latency-Network](./13-DPDK-Low-Latency-Network/) | DPDK · 用户态旁路 |
| 14 | [14-HFT-Low-Latency-Practice](./14-HFT-Low-Latency-Practice/) | **动手实现** · C++ 低延迟工程 |
| 15 | [15-Rust-Quant-Trading-Guide](./15-Rust-Quant-Trading-Guide/) | **动手实现** · Rust 量化 |

> **系统段：** `07` TLPI 补齐 Linux syscall / epoll；`08` 自制 → `09` PNP 实战 → `10` UNP API。
