...
详见 [READING-LIST.md §与 10 映射](../READING-LIST.md#与-10-hft-low-latency-practice-章节映射)

## 交叉阅读

- 网络技术栈 → [04](../04-TCP-IP-Illustrated-Vol1/) · [05](../05-UNP-Vol1/) · [06](../06-Linux-Kernel-Networking/) · [12](../12-DPDK-Low-Latency-Network/)
- 跨模块总览 → [CROSS-MODULE-GUIDE.md](../CROSS-MODULE-GUIDE.md)
- Rust 工程 → [11-Rust-Quant-Trading-Guide](../11-Rust-Quant-Trading-Guide/)
