...
**文件夹 `08`** · 外部书目 **PNP** · [返回总清单](../READING-LIST.md#补充陈硕-pnp--muduo-实战08-文件夹)

> **与 UNP 分工：** [PNP](https://github.com/cshonor/Computer-Networking/tree/main/PNP) = 工程向实验；[UNP Vol.1](../09-UNP-Vol1/) = Stevens 系统化 API 笔记。  
> **推荐顺序：** `07` 自制系统 → **本模块 `08`** → `09` UNP → `10` TCP/IP 协议对照 → `11` Rosen → `12` DPDK
