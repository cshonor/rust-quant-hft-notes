...
> **文件夹 14** · 紧接 [14-Systems-Performance](../14-Systems-Performance-2nd/) · **同样后置**（见 [LEARNING-CHAIN](../LEARNING-CHAIN.md)）。  
> **建议时机：** 已有 Linux 内核/网络/DPDK 或 HFT 压测靶子后再开 — 用 BPF 验证真实系统。  
> **后续：** [16-HFT](../16-HFT-Low-Latency-Practice/) / [17-Rust](../17-Rust-Quant-Trading-Guide/)
...
与 [01-CSAPP](../01-CSAPP-3rd/) · [14-Systems-Performance](../14-Systems-Performance-2nd/) 同一套约定。
...
- **上一本（必读前置）** → [14-Systems-Performance-2nd](../14-Systems-Performance-2nd/) — 读完立刻读本目录
- SysPerf bpftrace 附录 → [02 appendix-C](../14-Systems-Performance-2nd/appendix-C-bpftrace单行命令.md)
- 后续内核/内存/网络 → [03-Linux-Kernel-Development](../03-Linux-Kernel-Development/) · [05-Linux-Virtual-Memory-Manager](../05-Linux-Virtual-Memory-Manager/) · [13-Rosen](../12-Linux-Kernel-Networking/)（读时可回头用 BPF 验证）
- DPDK 对照 → [13-DPDK](../13-DPDK-Low-Latency-Network/)
