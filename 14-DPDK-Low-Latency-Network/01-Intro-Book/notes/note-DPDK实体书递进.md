...
| **XDP / tc-BPF** | 内核最早点丢/改包 | 对比 DPDK 的「半旁路」；见 [02-Advanced note-XDP](../../02-Advanced-Book/notes/note-XDP与DPDK对照.md) · [15-BPF note-XDP](../../../16-BPF-Performance-Tools/note-XDP与tc-BPF.md) |
...
- 回到 [17-HFT-Low-Latency-Practice](../../../17-HFT-Low-Latency-Practice/) ch06/ch08 — 把技术落到量化系统
- 用 [15-BPF](../../../16-BPF-Performance-Tools/) + `03` SysPerf Ch10 在生产上**验证**旁路收益
