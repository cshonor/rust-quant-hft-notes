...
与 **RSS 对称哈希**（[Ch8](../chapter-08-流分类与多队列/notes/section-3-硬件流分类.md)）对比：
...
- **tail latency：** Distributor 成为 **单点** — 需 **批量分发**、Worker 数与核数匹配 [Ch3 Gustafson](../chapter-03-并行计算/notes/section-2-多核性能与可扩展性.md)
