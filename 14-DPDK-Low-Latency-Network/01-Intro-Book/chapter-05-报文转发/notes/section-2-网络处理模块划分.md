...
| **3. 并行** | 多核 RTC 或 Pipeline + [Ch3 并行](../chapter-03-并行计算/) |

→ 网卡能力对照 [Ch8 offload](../chapter-08-流分类与多队列/notes/section-3-硬件流分类.md) · 内核路径 [13-LKN](../../../13-Linux-Kernel-Networking/)
...
| 核间队列 | **rte_ring** — [Ch4 无锁](../chapter-04-同步互斥机制/notes/section-5-无锁机制.md) |
