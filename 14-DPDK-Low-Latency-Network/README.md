...
- 缓存 / 内存 → [01-CSAPP-3rd Ch6](../01-CSAPP-3rd/chapter-06-memory-hierarchy/)、[03-Computer-Architecture-6th](../03-Computer-Architecture-6th/)
- 生产观测 → [16-BPF-Performance-Tools](../16-BPF-Performance-Tools/)
- 工程落地 → [17-HFT-Low-Latency-Practice](../17-HFT-Low-Latency-Practice/)
