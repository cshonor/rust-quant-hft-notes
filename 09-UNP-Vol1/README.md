...
**定位：** 用户态 Socket API · **标准内核网络路径** — 在 [08 PNP](../08-Practical-Network-Programming/) 写过服务骨架之后，系统化 Stevens API。
...
笔记已在你的网络书仓库维护；建议 **先 [08 PNP](../08-Practical-Network-Programming/) 再读本目录**。
