...
3. 确认 **swap 关闭 / 关键内存 mlock**；THP 策略与 [note-THP](../../06-Linux-Virtual-Memory-Manager/chapter-03-page-table-management/notes/note-透明大页THP.md) 一致。
...
- LKD 内核笔记：[04-Linux-Kernel-Development](../../04-Linux-Kernel-Development/00_Book_3rd_Notes/)
