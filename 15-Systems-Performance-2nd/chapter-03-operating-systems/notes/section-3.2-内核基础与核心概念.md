...
**调优直觉：** 热路径 **少 syscall、少拷贝、少阻塞**；内核旁路见 [13-DPDK](../../../14-DPDK-Low-Latency-Network/)、用户态栈。
...
- **isolcpus / 专用核**： housekeeping 与 hot path 分离 → [10-HFT ch05](../../../17-HFT-Low-Latency-Practice/chapter-05-操作系统内核极致调优/)
- Linux 里程碑：**O(1) 调度器** → **CFS**（完全公平调度，默认策略）

→ 深入进程/调度：[LKD 3rd Ch 3](../../../04-Linux-Kernel-Development/00_Book_3rd_Notes/chapter-03-process-management/) · [Ch 4 调度](../../../04-Linux-Kernel-Development/00_Book_3rd_Notes/chapter-04-process-scheduling/)
...
→ 精读：[06-Linux-Virtual-Memory-Manager](../../../06-Linux-Virtual-Memory-Manager/) Ch 3 页表/TLB/大页；[note-透明大页 THP](../../../06-Linux-Virtual-Memory-Manager/chapter-03-page-table-management/notes/note-透明大页THP.md)
