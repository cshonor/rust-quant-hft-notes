...
> **HFT：** 生产裸机 **bpftrace/BCC 与 perf 并列标配** — off-CPU、run queue、重传、direct reclaim；深度专书 → [16-BPF-Performance-Tools](../../16-BPF-Performance-Tools/)。
...
SysPerf Ch 1–14  →  Ch 15 BPF 总入口
  → 16-BPF-Performance-Tools 全书（紧接 14 SysPerf）
...
- XDP：[15-BPF note-XDP](../../16-BPF-Performance-Tools/note-XDP与tc-BPF.md) · [13-DPDK 02-Advanced](../../14-DPDK-Low-Latency-Network/02-Advanced-Book/notes/note-XDP与DPDK对照.md)
