...
- 与 housekeeping（日志、监控）**分进程/分核**（→ [12-HFT ch05](../../../14-HFT-Low-Latency-Practice/chapter-05-操作系统内核极致调优/)）
...
- 行情/订单：**socket 也是文件描述符** — `epoll` 等多路复用（→ [Ch 10–11](../../chapter-10-system-io/)、[08-UNP](../../../10-UNP-Vol1/)）
