...
> 本章定位：**socket API + TCP/IP 程序员视角** — 从客户端-服务器模型到 `socket/connect/bind/listen/accept`、`getaddrinfo`、Echo 与 Tiny Web。HFT **订单/行情通道** 的 POSIX 地基；极致延迟再叠 [08-UNP](../../10-UNP-Vol1/) · [10-DPDK](../../13-DPDK-Low-Latency-Network/)。
