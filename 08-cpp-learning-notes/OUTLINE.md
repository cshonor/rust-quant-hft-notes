...
| **Modern 先于 muduo** | [10 PNP](../09-Practical-Network-Programming/) 是 C++ 工程；**`04-Effective-Modern-C++` 是硬门槛** |
| **并发先于 HFT 引擎** | [16 HFT](../16-HFT-Low-Latency-Practice/) 热路径 = 多线程 + 无锁；**`08-Cpp-Concurrency` 必过** |
...
**验收：** 能读 muduo 里 `shared_ptr` / 回调 / 移动语义不懵 → 再开 [10 PNP](../09-Practical-Network-Programming/)。
...
| 外部目录 | 书目 | 何时 |
|----------|------|------|
| [08-Cpp-Concurrency](https://github.com/cshonor/cpp-learning-notes/tree/main/08-Cpp-Concurrency) | C++ 并发编程实战 | **10–13 网络栈进行中或之后、16 HFT 之前** |
...
| 外部目录 | 书目 | 何时 |
|----------|------|------|
| [09-C++20-The-Complete-Guide](https://github.com/cshonor/cpp-learning-notes/tree/main/09-C++20-The-Complete-Guide) | Josuttis C++20 | **16 HFT 主线跑通后**；Concepts / Coroutines / Modules |
