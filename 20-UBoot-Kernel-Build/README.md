...
> **前置：** [18 ARM64](../19-ARM64-Architecture/) · [05 LKD](../04-Linux-Kernel-Development/) 调度/中断概念
...
| 模块 | 复用什么 |
|------|----------|
| [05 LKD](../04-Linux-Kernel-Development/) | Kconfig、模块、启动流程 |
| [06 ULK](../05-Understanding-Linux-Kernel/) | 启动初期内存、中断初始化 |
| [07 Gorman](../06-Linux-Virtual-Memory-Manager/) | 页表、ZONE — 裁剪内核时懂删什么 |
| [08 TLPI](../07-The-Linux-Programming-Interface/) | rootfs 里用户态程序仍走 syscall |
...
**上一章：** [18 ARM64](../19-ARM64-Architecture/) · **下一章：** [20 Linux 驱动](../21-Linux-Device-Driver/)
