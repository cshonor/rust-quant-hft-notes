...
**定位：** 用户态 Socket API — 在 [09 PNP](../09-Practical-Network-Programming/) 与 **`08` TLPI** 之后，系统化 Stevens API。
...
笔记已在你的网络书仓库维护；建议 **先 [10 PNP](../09-Practical-Network-Programming/) 再读本目录**。
