...
- 后续内核/内存/网络 → [02-LKD](../05-Linux-Kernel-Development/) · [03-Gorman](../06-Linux-Virtual-Memory-Manager/) · [06-Rosen](../13-Linux-Kernel-Networking/)（读时可回头用 BPF 验证）
- DPDK 对照 → [10-DPDK](../14-DPDK-Low-Latency-Network/)
