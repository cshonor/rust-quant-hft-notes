...
> **后续：** `05`–`11` 系统纵深 · [12-HFT](../14-HFT-Low-Latency-Practice/) / [13-Rust](../15-Rust-Quant-Trading-Guide/)
...
- 后续内核/内存/网络 → [02-LKD](../05-Linux-Kernel-Development/) · [03-Gorman](../06-Linux-Virtual-Memory-Manager/) · [06-Rosen](../12-Linux-Kernel-Networking/)（读时可回头用 BPF 验证）
- DPDK 对照 → [10-DPDK](../13-DPDK-Low-Latency-Network/)
