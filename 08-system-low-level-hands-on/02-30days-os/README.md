...
与 [14-Systems-Performance](../../15-Systems-Performance-2nd/) / [04-Linux-Kernel-Development](../../04-Linux-Kernel-Development/00_Book_3rd_Notes/) 一致：每个 Day 独立目录，导读 + 分段笔记。
...
- [ ] 与 [04-Linux-Kernel-Development](../../04-Linux-Kernel-Development/) Ch4/7/8 对照表
...
| [04-Linux-Kernel-Development](../../04-Linux-Kernel-Development/) | 中断、调度、内存管理 **真实实现** |
| [07-The-Linux-Programming-Interface](../../07-The-Linux-Programming-Interface/) | 用户态 API 与内核边界（**可与本书并行**） |
